...
from splat_annotate.camera.fov import FOVCamera, load_camera_json
...
class Workspace:
  ...
  def load_model(self, model:str | None=None) -> Gaussians:
    if model is None:
